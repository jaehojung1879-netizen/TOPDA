...
LAWD_CANDIDATES = {
    ...
    # 개편 — 기존 29140/29155 전 기간 0건의 원인. 새 시도코드 미확인 상태라 유력 대역을
    # 자가탐색한다. 행정코드 순서는 '시(목포·여수·순천·광양·나주)→구(동·서·남·북·광산)→군'
    # 으로 확정(2026-04-28 발표) — 통상 배분(110,130,…)이면 서구=XX230, 남구=XX250.
    # 새 시도코드는 강원(42→51)·전북(45→52) 선례상 53+ 유력. 채택 코드는 CI 로그
    # [LAWD 자가탐색]에 남는다 — 확인되면 LAWD 본표에 고정할 것.
    "광주 서구": ["53230", "53140", "54230", "54140", "55230", "55140", "46230", "46140", "29140"],
    "광주 남구": ["53250", "53155", "54250", "54155", "55250", "55155", "46250", "46155", "29155"],
}
