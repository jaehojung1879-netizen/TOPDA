  ...
  window.TOPDA_RATES = {
    ...
    dsr: {
      ...
      applicability: {
        ...
        // ⚠ 유가증권(주식)담보대출의 산정만기는 **아직 확정하지 못했다.**
        //   같은 자료 안에서 두 갈래로 읽힌다:
        //     · 「오피스텔 外 비주택담보대출 8년」의 주1)이 '기타담보대출'을 포함한다 → 8년
        //     · 본표에 「기타담보대출 10년」이 별도 행으로 있다 → 10년 (주4) 각주는 미확인)
        //   실사용자 원장으로도 갈리지 않는다 — 잔액 29,934,000 · 연간원리금 4,867,000은
        //     8년이면 금리 3.76%, 10년이면 6.26%로 둘 다 성립한다.
        //     (한국증권금융 담보대출 금리대를 보면 10년/6.26% 쪽이 더 그럴듯하다.)
        //   한도를 과대 산출하지 않는 쪽(= 기존 부채를 크게 잡는 8년)을 기본값으로 둔다.
        securedLoanTermUnresolved: {
          candidates: [8, 10],
          usedYears: 8,
          reason: '두 값 중 기존 부채를 크게 잡아 한도를 과대 산출하지 않는 쪽을 택함',
          resolveBy: '해당 대출의 실제 약정금리(3.76%면 8년, 6.26%면 10년) 또는 기준표 주4) 각주',
          confidence: 'needs-verification',
        },
        includedWithAssumedTerm: [
          { kind: '유가증권(주식)담보대출', years: 8, confidence: 'needs-verification' },
