...
const T = {
  ...
  'brokerage-fee': {
    en: { title: 'Brokerage Fee Calculator', desc: 'Calculate the maximum real estate agent commission for a sale or Jeonse in Seoul.', crumb: 'Brokerage Fee', meta: 'Seoul max rates · negotiable in practice · VAT additional', ttype: 'Transaction type', sale: 'Sale', jeonse: 'Jeonse lease', value: 'Transaction value (KRW)', valueHint: 'Sale price for purchases; deposit for Jeonse.', totalH: 'Maximum total (incl. VAT)', rate: 'Rate', cap: 'Cap', fee: 'Commission (excl. VAT)', vat: 'VAT (10%)', note: 'These are caps, not fixed rates. The actual fee is negotiable. VAT applies only if the agent is a standard taxpayer.' },
