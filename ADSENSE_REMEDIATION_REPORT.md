...
**연락 창구**: 13항은 게시판으로 문의·삭제 요청을 받는다고 안내합니다. 회원가입 없이 쓸 수
있고 비밀글이 되므로 개인정보 삭제 요청 창구로 기능합니다. 전자우편 주소는 두지 않으며,
...
| `site/contact.html` | 게시판 바로가기, 비밀글 안내, 어떤 내용을 적으면 좋은지, 답변이 어려운 질문 |
